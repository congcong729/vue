<template>
  <div class="shop-header">
    ...
    <div class="shop-brief-modal" style="display: none;" v-show="isShowBulletin" @click="isShowBulletin=false">
    ...
    <div class="activity-sheet" style="display: none;" v-show="isShowSupports" @click="isShowSupports=false">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
        优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="activeClasses[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
